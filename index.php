...
<script type="text/javascript">
  function enabledisableAmount(checkbox) {
        var txtPassportNumber = document.getElementById("amount");
        ...
        <br>
          ...
          <div class="form-group">
             <h3>How would you like to pay?</h3>
              <input value="PKR" type="button" name="currency" class="btn" id="show1"/>
              <input value="USD"  type="button" name="currency" class="btn" id="show"/>
          </div>
      </h3>
  <div>
      ...
      <div class="form-group">
          ...
          <div>
             <div style="width: 80%;">
                ...
                <input type="number" placeholder="Amount" class="form-control" id="amount1" disabled="disabled" required>
